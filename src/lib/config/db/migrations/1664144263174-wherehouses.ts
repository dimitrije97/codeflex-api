...
export class wherehouses1664144263174 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "warehouse" ADD CONSTRAINT "FK_8aab4a2948b67717380f268c1b5" FOREIGN KEY ("partId") REFERENCES "computer_part"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
